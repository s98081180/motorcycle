...
public class btnfixinsertpage1 extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.btnfixinsertpage1);
    ...
    private Button.OnClickListener btnbackheadListener=new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            intent.setClass(btnfixinsertpage1.this,MainActivity.class);
