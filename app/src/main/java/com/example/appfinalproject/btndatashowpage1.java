...
public class btndatashowpage1 extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.btndatashowhowpage1);
    ...
    private Button.OnClickListener btnbackheadListener=new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            intent.setClass(btndatashowpage1.this,MainActivity.class);
